...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 18:01:02 2021

@author: shubham
"""

#Naive Bayes Model for Social Network Users dataset
...
matplotlib.pyplot.title("Naive Bayes (Training Set)")
...
for i, j in enumerate(numpy.unique(y_graph)):
    matplotlib.pyplot.scatter(x_graph[y_graph == j, 0], x_graph[y_graph == j, 1], c = ['red', 'green'][i], label = j)
matplotlib.pyplot.title("Naive Bayes (Test Set)")
matplotlib.pyplot.xlabel("Age")
matplotlib.pyplot.ylabel("Salary")
matplotlib.pyplot.legend()
matplotlib.pyplot.show()