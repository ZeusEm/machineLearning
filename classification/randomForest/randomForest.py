...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 19:38:28 2021

@author: shubham
"""

#Random Forest for Social Network Users dataset
...
#Feature Scaling - ONLY REQUIRED DUE TO SCALE/ MEMORY LIMITATIONS due to the final visualisation graph computing values for every pixel, hence feature scaling helps limit the computation set
...
matplotlib.pyplot.title("Random Forest (Training Set)")
...
for i, j in enumerate(numpy.unique(y_graph)):
    matplotlib.pyplot.scatter(x_graph[y_graph == j, 0], x_graph[y_graph == j, 1], c = ['red', 'green'][i], label = j)
matplotlib.pyplot.title("Random Forest (Test Set)")
matplotlib.pyplot.xlabel("Age")
matplotlib.pyplot.ylabel("Salary")
matplotlib.pyplot.legend()
matplotlib.pyplot.show()